...
LABEL MAINTAINER="" \
	...
	COMMENT="Order Management microservice based on MSR" \
	CUSTOM="true" \
	SAG="true" \
	BUILD=build-msc \
...
# files to be added to based image (includes configuration and package)
	...
	ADD --chown=sagadmin ./packages/OrderManagement /opt/softwareag/IntegrationServer/packages/OrderManagement
